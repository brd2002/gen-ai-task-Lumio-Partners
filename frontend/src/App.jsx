...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await axios.post('https://gen-ai-task-lumio-partners-dp8j.vercel.app/api/generate', { prompt });
  ...
  const handleSend = async () => {
    ...
    try {
      await axios.post('https://gen-ai-task-lumio-partners-dp8j.vercel.app/api/send', { recipients, email: emailContent  , prompt});
